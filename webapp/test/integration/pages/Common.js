sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("stickyheaders/app", ".html");
		...
		return Opa5.extend("stickyheaders.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["stickyheaders/localService/mockserver"], function (mockserver) {
